	...
	def main(self):
		...
		while 1:
			...
			for event in pygame.event.get():
				...
				#Row 5 End#
								#Row 6 Start#
				self.screen.blit(self.dot_small.image, (self.dot_small.rect.x+101, self.dot_small.rect.y+33*5))
				...
				self.screen.blit(self.dot_small.image, (self.dot_small.rect.x+314+32*3, self.dot_small.rect.y+33*5))
				#Row 6 End#
				#Row 7 Start#
				i = 6
				#self.screen.blit(self.dot_small.image, (self.dot_small.rect.x+5, self.dot_small.rect.y+33*i))
				#self.screen.blit(self.dot_small.image, (self.dot_small.rect.x+37, self.dot_small.rect.y+33*i))
				#self.screen.blit(self.dot_small.image, (self.dot_small.rect.x+69, self.dot_small.rect.y+33*i))	
				self.screen.blit(self.dot_small.image, (self.dot_small.rect.x+101, self.dot_small.rect.y+33*i))
				#self.screen.blit(self.dot_small.image, (self.dot_small.rect.x+133, self.dot_small.rect.y+33*i))
				self.screen.blit(self.dot_small.image, (self.dot_small.rect.x+165, self.dot_small.rect.y+33*i))
				self.screen.blit(self.dot_small.image, (self.dot_small.rect.x+189, self.dot_small.rect.y+33*i))
				self.screen.blit(self.dot_small.image, (self.dot_small.rect.x+222, self.dot_small.rect.y+33*i))
				self.screen.blit(self.dot_small.image, (self.dot_small.rect.x+222+32, self.dot_small.rect.y+33*i))
				self.screen.blit(self.dot_small.image, (self.dot_small.rect.x+283, self.dot_small.rect.y+33*i))
				self.screen.blit(self.dot_small.image, (self.dot_small.rect.x+314, self.dot_small.rect.y+33*i))
				self.screen.blit(self.dot_small.image, (self.dot_small.rect.x+314+32, self.dot_small.rect.y+33*i))
				#self.screen.blit(self.dot_small.image, (self.dot_small.rect.x+314+32*2, self.dot_small.rect.y+33*i))
				self.screen.blit(self.dot_small.image, (self.dot_small.rect.x+314+32*3, self.dot_small.rect.y+33*i))
				#self.screen.blit(self.dot_small.image, (self.dot_small.rect.x+314+32*4, self.dot_small.rect.y+33*i))
				#self.screen.blit(self.dot_small.image, (self.dot_small.rect.x+308+32*5, self.dot_small.rect.y+33*i))
				#self.screen.blit(self.dot_small.image, (self.dot_small.rect.x+305+32*6, self.dot_small.rect.y+33*i))
				i = 7	
				self.screen.blit(self.dot_small.image, (self.dot_small.rect.x+101, self.dot_small.rect.y+33*i))
				self.screen.blit(self.dot_small.image, (self.dot_small.rect.x+165, self.dot_small.rect.y+33*i))
				self.screen.blit(self.dot_small.image, (self.dot_small.rect.x+314+32, self.dot_small.rect.y+33*i))
